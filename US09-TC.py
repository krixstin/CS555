...
class US09TC(unittest.TestCase):
    ...
    INDI_F = {
        '@I1@': ['Javier /Diaz/', 'M', '27 AUG 2000', 20, True, 'N/A', ['@F1@', 'N/A']],
        '@I2@': ['Miguel /Diaz/', 'M', '9 SEP 1967', 53, False, '27 AUG 1999', ['N/A', '@F1@'], ['N/A', '@F2@'],
                 ['@F3@', 'N/A']],
        '@I3@': ['Deysi /Geronimo/', 'F', '3 JAN 1979', 41, True, 'N/A', ['N/A', '@F1@'], ['@F4@', 'N/A']],
        '@I4@': ['Xavier /Diaz/', 'M', '27 AUG 2000', 20, True, 'N/A', ['@F1@', 'N/A']],
        '@I5@': ['Cesar /Geronimo/', 'M', '23 MAY 1944', 76, True, 'N/A', ['N/A', '@F4@']],
    ...
    def test_T_birth(self):
        self.assertTrue(US09.birth_before_death(FAM, INDI))

    def test_F_birth(self):
        self.assertTrue(US09.birth_before_death(FAM, INDI_F))
