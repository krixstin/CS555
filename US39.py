...
# Author: Kristin Kim
"""
comment out line 26 (month), 27 (day) to get the real data. This is set as 10 APR (current year) for unittest
"""
                ...
                if marriage_dates != []:
                    ...
                    if month == month_list[index]:
                        if day > t_day:
                            ...
                            l.append(name)
                            l.append(str_full)
                            print(first + " " + last + "'s, " + str_full[:] + " is in the next 30 days")
...
print(recent_marriage("Cesar Geronimo"))    # check if name is in list l
